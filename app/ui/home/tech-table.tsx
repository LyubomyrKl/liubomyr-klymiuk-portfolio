...
const TechTable = () => {
    return (
        <div className='grid relative' style={{
            ...
            <div className='first-horizontal-line absolute h-[1px] border border-app-border w-[0] top-0 animation-delay-1000 animate-expand-horizontal-line-type-4'></div>
            <div className='second-horizontal-line absolute h-[1px] border border-app-border w-[0] top-[16.5%] right-0 animate-expand-horizontal-line-type-2'></div>
            <div className='third-horizontal-line absolute h-[1px] border border-app-border w-[0] top-[33%] animate-expand-horizontal-line-type-1'></div>
            <div className='last-horizontal-line absolute h-[1px] border border-app-border w-[0] bottom-0 right-0 animate-expand-horizontal-line-type-3'></div>


            <div className={'py-10 flex items-end text-3xl font-semibold relative'}>
                <div className='absolute w-[1px] border border-app-border h-[0] top-0 right-0 animate-expand-vertical-line-type-3'></div>
                Hard Skills
            </div>
            <div className={'p-10 flex items-end text-3xl font-semibold relative'}>
                <div className='absolute w-[1px] border border-app-border h-[0] bottom-0 right-0 animation-delay-2500 animate-expand-vertical-line-type-2'></div>
                Soft Skills
            </div>
            <div className={'p-10 flex items-end text-3xl font-semibold relative'}>
                <div className='absolute w-[1px] border border-app-border h-[0] top-0 right-0 animate-expand-vertical-line-type-1'></div>
                Methodologies
            </div>


            <div className=" flex items-center text-xl font-semibold grid grid-cols-3 relative">
                <div className='first-vertical-line absolute w-[1px] border border-app-border h-[0] bottom-0 right-0 animation-delay-3000 animate-expand-vertical-line-type-2'></div>
            ...
            <div className="pl-10 flex items-center text-xl font-semibold relative">
                <div className='first-vertical-line absolute w-[1px] border border-app-border h-[0] bottom-0 right-0 animate-expand-vertical-line-type-2'></div>
                <span><FaTasks className='text-2xl mr-2 -mt-1'/>Job Related</span>
            </div>
            <div className="pl-10 flex items-center text-xl font-semibold relative">
                <div className='first-vertical-line absolute w-[1px] border border-app-border h-[0] top-0 right-0 animation-delay-3000 animate-expand-vertical-line-type-3'></div>
                <span><FaBriefcase className='text-2xl mr-2 -mt-1'/> Management</span>
            </div>


            <div className={'py-5 grid grid-cols-3 relative'}>
                <div className='absolute w-[1px] border border-app-border h-0 bottom-0 right-0 animate-expand-vertical-line-type-1'></div>
            ...
            <div className={'px-10 py-5 relative'}>
                <div className='first-vertical-line absolute w-[1px] border border-app-border h-0 top-0 right-0 animate-expand-vertical-line-type-2'></div>
                <div className='flex flex-col'>
            ...
            <div className={'px-10 py-5 relative'}>
                <div className='first-vertical-line absolute w-[1px] border border-app-border h-0 top-0 bottom-0 right-0 animate-expand-vertical-line-type-3'></div>
                <div className='flex flex-col'>
